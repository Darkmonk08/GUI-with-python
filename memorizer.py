...
save=Button(frame1,text="Save",font=("Ariel",15),background="light grey",width=30)
save.pack(side=TOP,pady=10)

open=Button(frame1,text="Open",font=("Ariel",15),background="light grey",width=30)
...
listbox=Listbox(frame2,font=("Ariel",15),width=30)
